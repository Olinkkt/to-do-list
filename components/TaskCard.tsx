          ...
          <>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center mt-6 gap-4">
              ...
              {sortBy === 'custom' && (
                <div className="flex gap-2 order-2 sm:order-1">
                  <button
                    onClick={onMoveUp}
                    disabled={isFirst}
                    className="flex-1 sm:flex-none px-4 py-2 rounded-xl bg-gray-800/50 text-gray-300
                  ...
                  >
                    ...
                    <span className="hidden sm:inline">Dolů</span>
                  </button>
                </div>
              )}
              {sortBy !== 'custom' && <div className="order-2 sm:order-1"></div>}
              ...
              <div className="flex flex-wrap gap-3 order-1 sm:order-2">
                ...
                <button 
                  onClick={handleEdit}
                  className="flex-1 sm:flex-none px-4 py-2 rounded-xl bg-blue-500/20 text-blue-300 
                ...
                <button 
                  ...
                  className="flex-1 sm:flex-none px-4 py-2 rounded-xl bg-red-500/20 text-red-300 
